...
function MeshGenerator(L,h1,h2,h3,hd,Lt,ht,dpml,l0,ld,lpml)
    gmsh.initialize()
    ...
    gmsh.model.geo.addPlaneSurface([14,19], 14)
    ...
    gmsh.model.addPhysicalGroup(2, [13,14,15], 23)
    gmsh.model.setPhysicalName(2, 23, "Target1")
    gmsh.model.addPhysicalGroup(2, [19], 24)
    gmsh.model.setPhysicalName(2, 24, "Target2")
    gmsh.model.addPhysicalGroup(2, [4,5,6,7,8,9], 25)
    gmsh.model.setPhysicalName(2, 25, "Incident")
